    ...
    def onMessage(self, ws, message):
        try:
            ...
            if type(message) == str:
                ...
                qrCodeContents = '2@NqwuHFQX7+4gRC4Vp+aTb3gmHfB4BjhVNVECWgL+GhTb9MM+KfsBGqIFHZ+tp2oaUq+iseAcOlvTYw==,B8a/JQSHXXCHkOEo5esa7gC4VOXu7d06SUfDpLjWYBs=,T4LWGCI3USTNrZrMf5RYzDIoA7p6lM2D8KGR1GM4REA=,TP6DJ7Y/VNV0KHpfCP6+kCvE9vYMvBVlapFtL9W1dLs=,1'
